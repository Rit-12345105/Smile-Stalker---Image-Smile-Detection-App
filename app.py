...
@st.cache_resource
def load_model():
    model = joblib.load(r"G:\SS\Image_Classification\Image_Classification\env\smile_stalker.pkl")
    scaler = joblib.load(r"G:\SS\Image_Classification\Image_Classification\env\scaler.pkl")
    return model, scaler
